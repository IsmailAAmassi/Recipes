...
interface RecipeRepository {
    ...
    suspend fun getMostLovedRecipes(): Flow<DataState<List<RecipeDto>>>

    suspend fun getBestCollectionRecipes(): Flow<DataState<List<RecipeDto>>>

    suspend fun getMostViewedRecipes(): Flow<DataState<List<RecipeDto>>>

    suspend fun getFavouritesRecipes(): Flow<DataState<List<RecipeDto>>>
